# tax-doc-sdk-tax1099sb

Software development kit to generate IRS Form 1099-SB as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Sb.sample.png" width="850"/>
